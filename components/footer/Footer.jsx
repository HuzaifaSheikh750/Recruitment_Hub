  ...
  return (
    <>
      ...
      <div className="col-xl-3 col-lg-4 col-md-5 mb-30">
        ...
        <p className="text-white opacity-75 mb-35 poppins">
        <i className="fas fa-map-marker-alt text-white fs-20 " style={{marginRight:"5px"}} /> 590 Madison Avenue 21st Floor Manhattan, NY 10022 USA.<br/><br/>
        <i className="fas fa-map-marker-alt text-white fs-20 " style={{marginRight:"5px"}}/> 415 W. Golf Rd Suite 55-K (607 SF) Arlington Heights, IL 60005.<br/><br/>
        <i className="fas fa-map-marker-alt text-white fs-20 " style={{marginRight:"5px"}}/> Suite#213 Sumya Business Avenue MACHS Karachi, Pakistan.
        </p>
